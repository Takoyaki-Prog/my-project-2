...
class MarketingResource extends Resource
{
    ...
    protected static ?string $label = 'Marketing';
    ...
    public static function getFormComponents()
    {
        return [
            Forms\Components\Grid::make(2)
                ->schema([
                    Forms\Components\Section::make('Data indentitas marketing')
                    ...
                    Forms\Components\Section::make('Data akun marketing')
    ...
    public static function getInfolistComponents()
    {
        return [
            Infolists\Components\Grid::make(2)
                ->schema([
                    Infolists\Components\Section::make('Data indentitas marketing')
                    ...
                    Infolists\Components\Section::make('Data akun marketing')
